	...
	*/
	...
	private async getHMRHtmlContent(webview: vscode.Webview): Promise<string> {
		...
		const csp = [
			...
			// MCP Apps (SEP-1865): allow sandboxed iframes rendered via srcdoc
			"frame-src 'self' blob:",
		]
